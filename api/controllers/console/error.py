...
class AlreadySetupError(BaseHTTPException):
    ...
    description = "AI助手 has been successfully installed. Please refresh the page or return to the dashboard homepage."
    code = 403
...
class NotSetupError(BaseHTTPException):
    ...
    description = (
        "AI助手 has not been initialized and installed yet. "
