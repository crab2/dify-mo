...
const AppCard = ({
  ...
  return (
    <div className={cn('custom-brand-card custom-brand-template-card group relative flex h-[132px] cursor-pointer flex-col overflow-hidden rounded-xl border-[0.5px] border-components-panel-border bg-components-panel-on-panel-item-bg p-4 shadow-xs hover:shadow-lg')}>
